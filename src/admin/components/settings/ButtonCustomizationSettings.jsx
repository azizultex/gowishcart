...
const ButtonCustomizationSettings = ({ settings, updateSettings }) => {
    ...
    const LabelsSection = ({ labels }) => {
        ...
        return (
            <div className="space-y-4 border-t pt-4">
                <Label className="text-base font-semibold">{__('Button Labels', 'gowishcart-wishlist-for-fluentcart-pro')}</Label>
                
                <div className="space-y-2">
                    <Label htmlFor="label_add">{__('"Add to Wishlist" Text', 'gowishcart-wishlist-for-fluentcart-pro')}</Label>
                    <Input
                        ref={addLabelRef}
                        id="label_add"
                        type="text"
                        ...
                        placeholder={__('Add to Wishlist', 'gowishcart-wishlist-for-fluentcart-pro')}
                    />
                    <p className="text-sm text-muted-foreground">
                        {__('Text displayed when product is not in wishlist', 'gowishcart-wishlist-for-fluentcart-pro')}
                    </p>
                </div>

                <div className="space-y-2">
                    <Label htmlFor="label_saved">{__('"Saved to Wishlist" Text', 'gowishcart-wishlist-for-fluentcart-pro')}</Label>
                    <Input
                        ref={savedLabelRef}
                        id="label_saved"
                        type="text"
                        ...
                        placeholder={__('Saved to Wishlist', 'gowishcart-wishlist-for-fluentcart-pro')}
                    />
                    <p className="text-sm text-muted-foreground">
                        {__('Text displayed when product is in wishlist', 'gowishcart-wishlist-for-fluentcart-pro')}
                    </p>
                </div>
            </div>
        );
    ...
    // Font options
    const fontOptions = [
        { value: 'default', label: __('Use Default Font', 'gowishcart-wishlist-for-fluentcart-pro') },
    ...
    const handleMediaUpload = (iconType) => {
        ...
        if (typeof wp === 'undefined' || !wp.media) {
            alert(__('WordPress media library is not available. Please refresh the page.', 'gowishcart-wishlist-for-fluentcart-pro'));
            return;
        }

        const mediaUploader = wp.media({
            title: __('Select Icon', 'gowishcart-wishlist-for-fluentcart-pro'),
            button: {
                text: __('Use this icon', 'gowishcart-wishlist-for-fluentcart-pro')
            },
            multiple: false,
            library: {
                type: 'image'
        ...
        mediaUploader.on('select', function () {
            ...
            if (!attachment) {
                alert(__('No image selected. Please try again.', 'gowishcart-wishlist-for-fluentcart-pro'));
                return;
            }
            ...
            if (fileExtension !== 'png' && fileExtension !== 'svg') {
                alert(__('Please upload a PNG or SVG file only.', 'gowishcart-wishlist-for-fluentcart-pro'));
                return;
            }
            ...
            if (!imageUrl) {
                ...
                alert(__('Error: Could not get image URL. Please try again.', 'gowishcart-wishlist-for-fluentcart-pro'));
                return;
            }
        ...
        return (
            <div className="space-y-4 border rounded-lg p-4">
                ...
                >
                    <div className="flex items-center space-x-2">
                        ...
                        <Label htmlFor={`${iconType}_predefined`} className="cursor-pointer">
                            {__('Default Icon', 'gowishcart-wishlist-for-fluentcart-pro')}
                        </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                        <RadioGroupItem value="custom" id={`${iconType}_custom`} />
                        <Label htmlFor={`${iconType}_custom`} className="cursor-pointer">
                            {__('Custom Icon', 'gowishcart-wishlist-for-fluentcart-pro')}
                        </Label>
                    </div>
                </RadioGroup>
                ...
                {iconConfig.type === 'predefined' ? (
                    <div className="space-y-2">
                        <Label>{__('Select Icon', 'gowishcart-wishlist-for-fluentcart-pro')}</Label>
                        <IconPicker
                            selectedIcon={iconConfig.value}
                            onSelect={(iconName) => updateIcon(iconType, 'value', iconName)}
                            label={__('Select Icon', 'gowishcart-wishlist-for-fluentcart-pro')}
                            triggerLabel={iconConfig.value || __('Select Icon', 'gowishcart-wishlist-for-fluentcart-pro')}
                        />
                    ...
                    <div className="space-y-4">
                        <Label>{__('Custom Icon', 'gowishcart-wishlist-for-fluentcart-pro')}</Label>
                        ...
                        <div className="w-full">
                            {iconConfig.customUrl ? (
                                <div className="space-y-3">
                                    <div className="relative inline-block border-2 border-gray-300 rounded-lg p-4 bg-gray-50 hover:bg-gray-100 transition-colors">
                                        <img
                                            ...
                                            alt={__('Custom icon preview', 'gowishcart-wishlist-for-fluentcart-pro')}
                                        ...
                                        <Button
                                            ...
                                            title={__('Remove icon', 'gowishcart-wishlist-for-fluentcart-pro')}
                                        >
                                ...
                                <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 bg-gray-50 text-center">
                                    <p className="text-sm text-muted-foreground">
                                        {__('No icon selected', 'gowishcart-wishlist-for-fluentcart-pro')}
                                    </p>
                                </div>
                            )}
                        </div>
                        ...
                        <Button
                            ...
                            className="w-full"
                        >
                            {iconConfig.customUrl ? __('Change Icon', 'gowishcart-wishlist-for-fluentcart-pro') : __('Upload Icon', 'gowishcart-wishlist-for-fluentcart-pro')}
                        </Button>
                    </div>
                )}
            </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    {isGradient && (
                        <div 
                            ...
                            title={__('Color picker not available for gradients. Use text input to edit.', 'gowishcart-wishlist-for-fluentcart-pro')}
                        >
                        </div>
                    )}
                    <Input
        ...
        return (
            <div className="space-y-4 pt-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <ColorInput
                        label={__('Background Color', 'gowishcart-wishlist-for-fluentcart-pro')}
                    ...
                    />
                    <ColorInput
                        label={__('Background Hover Color', 'gowishcart-wishlist-for-fluentcart-pro')}
                    ...
                    />
                    <ColorInput
                        label={__('Button Text Color', 'gowishcart-wishlist-for-fluentcart-pro')}
                    ...
                    />
                    <ColorInput
                        label={__('Button Text Hover Color', 'gowishcart-wishlist-for-fluentcart-pro')}
                    ...
                    />
                    <div className="space-y-2">
                        <Label className="text-sm">{__('Font', 'gowishcart-wishlist-for-fluentcart-pro')}</Label>
                        <Select
                            value={sectionSettings.font || 'default'}
                            onValueChange={(value) => updateButtonCustomization(sectionKey, 'font', value)}
                        >
                            <SelectTrigger>
                                <SelectValue placeholder={__('Select font', 'gowishcart-wishlist-for-fluentcart-pro')} />
                            </SelectTrigger>
                            <SelectContent>
                    ...
                    <div className="space-y-2">
                        <Label className="text-sm">{__('Font Size', 'gowishcart-wishlist-for-fluentcart-pro')}</Label>
                        <Input
                            ref={fontSizeRef}
                            type="text"
                            value={fontSize}
                    ...
                    <div className="space-y-2">
                        <Label className="text-sm">{__('Icon Size', 'gowishcart-wishlist-for-fluentcart-pro')}</Label>
                        <Input
                            ref={iconSizeRef}
                            type="text"
                            value={iconSize}
                    ...
                    <div className="space-y-2">
                        <Label className="text-sm">{__('Border Radius', 'gowishcart-wishlist-for-fluentcart-pro')}</Label>
                        <Input
                            ref={borderRadiusRef}
                            type="text"
                            value={borderRadius}
    ...
    const buttonStyleOptions = [
        { value: 'button', label: __('Button (Text + Icon)gowishcart-wishlist-for-fluentcart-pro') },
        { value: 'text-only', label: __('Text Only', 'gowishcart-wishlist-for-fluentcart-pro') },
        { value: 'text-only-link', label: __('Text Only (No Button)gowishcart-wishlist-for-fluentcart-pro') },
        { value: 'text-icon-link', label: __('Text with Icon (No Button)gowishcart-wishlist-for-fluentcart-pro') },
        { value: 'icon-only', label: __('Icon Only', 'gowishcart-wishlist-for-fluentcart-pro') },
    ];
        ...
        <div className="gowishcart-button-customization-wrapper" style={{ display: 'grid', gridTemplateColumns: '1fr 400px', gap: '2rem', alignItems: 'start' }}>
            ...
            <div className="gowishcart-settings-section">
                ...
                <div className="space-y-4 pb-6 border-b">
                    <Label className="text-base font-semibold">{__('General Settings', 'gowishcart-wishlist-for-fluentcart-pro')}</Label>
                    <div className="space-y-2">
                        <Label className="text-sm">{__('Button Style', 'gowishcart-wishlist-for-fluentcart-pro')}</Label>
                        <Select
                            value={buttonStyle}
                            onValueChange={(value) => updateTopLevelProperty('buttonStyle', value)}
                        >
                            <SelectTrigger>
                                <SelectValue placeholder={__('Select button style', 'gowishcart-wishlist-for-fluentcart-pro')} />
                            </SelectTrigger>
                            <SelectContent>
                        ...
                        <p className="text-sm text-muted-foreground">
                            {__('Choose how the wishlist button should be displayed', 'gowishcart-wishlist-for-fluentcart-pro')}
                        </p>
                    </div>
                </div>
                ...
                {/* Button Section */}
                <ButtonSection
                    title={__('"Add To Wishlist" Button', 'gowishcart-wishlist-for-fluentcart-pro')}
                ...
                <ButtonSection
                    title={__('"Saved to Wishlist" Button', 'gowishcart-wishlist-for-fluentcart-pro')}
                ...
                {/* Icon Section */}
                <div className="space-y-4 border-t pt-4">
                    <Label className="text-base font-semibold">{__('Icons', 'gowishcart-wishlist-for-fluentcart-pro')}</Label>
                    <p className="text-sm text-muted-foreground">
                        {__('Configure separate icons for "Add to Wishlist" and "Saved to Wishlist" states', 'gowishcart-wishlist-for-fluentcart-pro')}
                    </p>
                    
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <IconSection
                            title={__('"Add to Wishlist" Icon', 'gowishcart-wishlist-for-fluentcart-pro')}
                            iconType="addToWishlist"
                            iconConfig={addToWishlistIcon}
                        />
                        <IconSection
                            title={__('"Saved to Wishlist" Icon', 'gowishcart-wishlist-for-fluentcart-pro')}
