            ...
            <DialogTrigger asChild>
                <Button type="button" variant="outline" className="w-full justify-start">
                    {SelectedIconComponent ? (
                        ...
                        triggerLabel || __('Select Icon', 'gowishcart-wishlist-for-fluentcart-pro')
                    )}
                </Button>
            </DialogTrigger>
            <DialogContent className="max-w-4xl max-h-[80vh] overflow-hidden flex flex-col">
                <DialogHeader>
                    <DialogTitle>{label || __('Select Icon', 'gowishcart-wishlist-for-fluentcart-pro')}</DialogTitle>
                </DialogHeader>
                <div className="flex flex-col gap-4 flex-1 overflow-hidden">
                    <div className="relative">
                        <Input
                            type="text"
                            placeholder={__('Search icons...', 'gowishcart-wishlist-for-fluentcart-pro')}
                            value={searchQuery}
                    ...
                    <div className="flex-1 overflow-y-auto border rounded-lg p-4">
                        ...
                        {filteredIcons.length === 0 && (
                            <div className="text-center py-8 text-muted-foreground">
                                {__('No icons found', 'gowishcart-wishlist-for-fluentcart-pro')}
                            </div>
                        )}
                    </div>
                </div>
