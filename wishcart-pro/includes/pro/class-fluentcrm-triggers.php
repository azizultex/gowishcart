...
/**
 * FluentCRM Triggers Registration Class (Pro)
 *
 ...
 */
class WishCart_Pro_FluentCRM_Triggers {
    ...
    public static function fire_trigger( $trigger_key, $data = array() ) {
        ...
        if ( ! empty( $user_email ) && class_exists( 'WishCart_Pro_FluentCRM_Integration' ) ) {
            $fluentcrm = new WishCart_Pro_FluentCRM_Integration();
