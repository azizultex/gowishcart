...
namespace GoWishCart_Wishlist\Appsero;
...
class Client {
     ...
     *
     * @return GoWishCart_Wishlist\Appsero\Insights
     */
    ...
    public function updater() {
        ...
        _deprecated_function( __CLASS__ . '::updater', '2.0', '\GoWishCart_Wishlist\Appsero\Updater::init($client);, for more details please visit: https://appsero.com/docs/appsero-developers-guide/appsero-client/appsero-sdk-updater-changes/' );

        // initialize the new updater
        if ( method_exists( '\GoWishCart_Wishlist\Appsero\Updater', 'init' ) ) {
            GoWishCart_Wishlist\Appsero\Updater::init( $this );
        }
    }
     ...
     *
     * @return GoWishCart_Wishlist\Appsero\License
     */
